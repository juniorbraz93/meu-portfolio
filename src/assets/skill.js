...
export const skillItem = [
  ...
  {
    titulo: 'JavaScript', Percentual: '85%', icon: <SiJavascript size={35} color="#F0DB4F" />, color: '#F0DB4F'
  },
  {
    titulo: 'TypeScript', Percentual: '65%', icon: <SiTypescript size={35} color="#007ACC" />, color: '#007ACC'
  },
  {
